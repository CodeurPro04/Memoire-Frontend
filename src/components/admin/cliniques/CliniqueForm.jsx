...
export default function CliniqueCreateForm({ onSubmit, onCancel, loading }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-1">
            ...
            <div className="pt-6 flex justify-end gap-3 border-t border-gray-100">
                ...
                <button 
                    ...
                    className="px-8 py-2.5 bg-blue-600 text-white text-sm font-bold rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-200 disabled:opacity-50 transition-all"
                >
                    {loading ? "Création..." : "Enregistrer la clinique"}
                </button>
            </div>
        </form>
    );
